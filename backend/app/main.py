...
app.include_router(model_finetuning.router)
app.include_router(model_dataset.router)
...
app.include_router(memory_context.router)
app.include_router(memory_retrieval.router)
app.include_router(memory_administration.router) 
app.include_router(core_memory.router)
app.include_router(audio_storage.router)
