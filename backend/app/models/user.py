...
workspaces_db: dict[str, dict] = {}                 # id -> {id, name, owner_email, status, created_at}
current_workspace_db: dict[str, str] = {}            # email -> workspace_id
recent_workspaces_db: dict[str, list[str]] = {}   
